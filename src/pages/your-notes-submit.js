      ...
      <section className="container" id="main">
          <div className="row">
              <div className="col-lg-12">
                  <h1 className="sm-type-biggerdrum sm-type-biggerdrum--medium mt-4">Your notes submission</h1>
              </div>
          </div>
          ...
          <div className="row" id="guest-3">
              ...
              <div className="col-lg-4">
                  ...
                  <div className="side-grey">
                      <p className="sm-type-amp">Dont forget to complete all the required tasks.</p>
                  </div>
              </div>
          </div>
