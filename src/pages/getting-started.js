                        ...
                        <div className="col-lg-4">
                            ...
                            <div className="side-grey">
                                <p className="sm-type-amp">
                                    When communities purchase the land on which
                                    their people live and work, they are freed
                                    to reinvigorate their areas and improve the
                            ...
                            <div className="side-grey">
                                ...
                                <div className="multiple-choice">
                                    ...
                                    <label className="form-label" htmlFor="id1">
                                        Did you answer all the 12 questions?
                                    </label>
                                </div>
                            </div>
