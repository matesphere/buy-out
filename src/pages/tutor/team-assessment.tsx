                    ...
                    <div className="row">
                        <div className="col-lg-9">
                            ...
                            <p className="sm-type-lead mb-4">
                                ...
                                throughout the QUEST, however the teacher may
                                wish to carry out a summative assessment of this
                                aspect of the work. The following provides
                                assessment criteria on which to provide
                                summative feedback to the groups. It is quick to
                                do and provides a score out of 50.
                                Alternatively, or in addition, it can be
                                completed in the form of comments which can then
                                be shared with the groups.
                            </p>
                            ...
                            <div className="table table-tutorassess">
                                ...
                                <div className="roww">
                                    <div className="cell">
                                        2. You have devised/used protocols for
                                ...
                                <div className="roww">
                                    <div className="cell">
                                        3. You have recognised the strengths of
                                        all in the group and put these to good
                                        use.
                                    </div>
                                    <div className="cell"></div>
                                    <div className="cell"></div>
                                ...
                                <div className="roww">
                                    <div className="cell">
                                        4. You have managed your time well and
                                        paid attention to time constraints.
                                    </div>
                                    <div className="cell"></div>
                                    <div className="cell"></div>
                                </div>
                                ...
                                <div className="roww">
                                    <div className="cell">
                                        6. You have responded well to feedback
                                        and used it to inform the next stages.
                                    </div>
                                    <div className="cell"></div>
                                    <div className="cell"></div>
                                </div>
                                <div className="roww">
                                    <div className="cell">
                                        ...
                                        arisen, you have worked constructively
                                        to find resolution.
                                    </div>
                                    <div className="cell"></div>
                                    <div className="cell"></div>
                                ...
                                <div className="roww">
                                    <div className="cell">
                                        9. You have taken care of one another
                                        and ensured that everyone is safe.
                                    </div>
                                    <div className="cell"></div>
                                    <div className="cell"></div>
                                </div>
