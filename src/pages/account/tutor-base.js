          ...
          <div className="row tutor mt-4">
              ...
              <div className="col-lg-8">
                  ...
                  <ul className="steps">
                      ...
                      <li>
                          <p className="steps-step sm-type-lead sm-type-lead--medium">Step 2</p>
                          <div>
                              <Tick />
                              <span>Completed</span>
                              <span><a href="#">student notes</a></span>
                      ...
                      <li>
                          <p className="steps-step sm-type-lead sm-type-lead--medium">Step 3</p>
                          <div>
                              <Cross />
                              <span>Submitted</span>
                              <span><a href="#">student notes</a></span>
                      ...
                      <li>
                          <p className="steps-step sm-type-lead sm-type-lead--medium">Step 4</p>
                          <div>
                              <Cross />
                              <span>LOCKED</span>
                      ...
                      <li>
                          <p className="steps-step sm-type-lead sm-type-lead--medium">Step 5</p>
                          <div>
                              <Cross />
                              <span>LOCKED</span>
                              <span><a href="#">unlock step</a></span>
                      ...
                      <li>
                          <p className="steps-step sm-type-lead sm-type-lead--medium">Step 6</p>
                          <div>
                              <Cross />
                              <span>LOCKED</span>
                              <span><a href="#">unlock step</a></span>
                      ...
                      <li>
                          <p className="steps-step sm-type-lead sm-type-lead--medium">Step 7</p>
                          <div>
                              <Cross />
                              <span>LOCKED</span>
                              <span><a href="#">unlock step</a></span>
                      ...
                      <li>
                          <p className="steps-step sm-type-lead sm-type-lead--medium">Step 8</p>
                          <div>
                              <Cross />
                              <span>LOCKED</span>
                              <span><a href="#">unlock step</a></span>
