      ...
      id === 10 ? (
        <div key={i}>
          <p className="sm-type-lead sm-type-lead--medium mt-4">
            Or choose your own option - check the box and enter your option name
            here!
          </p>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              onChange={({ target: { value } }) => setTeamChoiceName(value)}
            />
          </div>
        </div>
      ) : (
          ...
          <div className="row">
            <div className="col-lg-9">
              ...
              <p className="sm-type-lead mb-3">
                You will need to work together to discuss the available
                development options and decide on five which you think offer the
                best chance of providing benefits to the community - whether
            ...
            <div className="col-lg-3">
              ...
              <div className="side-grey">
                <div className="checklist">
                  ...
                  <p className="sm-type-lead">
                    Check the map and read through the detailed information on
                    each option.
                  </p>
                </div>
              </div>
              <div className="side-grey">
                <div className="checklist">
                  <div className="tick"></div>
                  <p className="sm-type-lead">
                    Based on what you've read, choose 5 of the options to
                    investigate further.
                  </p>
                </div>
              </div>
