                                ...
                                <ul>
                                    <li>
                                        <p className="sm-type-lead">
                                            Hold a community meeting to explore
                                            the options.
                                        </p>
                                        <ul className="mb-4">
                                            <li className="mb-2">
                                    ...
                                    <li>
                                        <p className="sm-type-lead">
                                            If there is community support, elect
                                            a Steering Group to take forward a
                                            possible purchase.
                                        </p>
                                        <ul className="mb-4">
                                            <li className="mb-2">
                            ...
                            <div className="side-grey">
                                ...
                                <div className="multiple-choice">
                                    ...
                                    <label className="form-label" htmlFor="id1">
                                        Hold a community meeting to explore the
                                        options.
                                    </label>
                                </div>
                                <div className="multiple-choice">
                                    ...
                                    <label className="form-label" htmlFor="id2">
                                        If there is community support, elect a
                                        Steering Group to take forward a
                                        possible purchase.
                                    </label>
                                </div>
                                ...
                                <p className="sm-type-amp">
                                    <Link to="/the-roles">
                                        Move onto choosing your Steering Group.
                                    </Link>
                                </p>
                            </div>
