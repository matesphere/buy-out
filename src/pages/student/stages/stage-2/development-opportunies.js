                ...
                <section className="container" id="main">
                    <div className="row">
                        <div className="col-lg-8">
                            <h2 className="sm-type-biggerdrum sm-type-biggerdrum--medium mt-4 mb-4">Development Options:</h2>
                            ...
                            <div className="table">
                                ...
                                <div className="roww">
                                    <div className="cell">
                                        <p><span className="greydot"></span> 1.	Affordable Housing Scheme</p>
                                    </div>
                                    <div className="cell">
                                        <p>Space for 3 pairs of semi-detached houses behind a row of existing houses. Affordable rent charged and low running costs.</p>
                                        <p><a href="/student/stage-2/affordable-housing-scheme">Read more about </a></p>
                                    </div>
                                </div>

                                <div className="roww">
                                    <div className="cell">
                                        <p><span className="yellowdot"></span> 2.	Play Park and/or Skate Park Scheme</p>
                                    </div>
                                    <div className="cell">
                                ...
                                <div className="roww">
                                    <div className="cell">
                                        <p><span className="reddot"></span> 3.	Shop and PO</p>
                                    </div>
                                    <div className="cell">
                                ...
                                <div className="roww">
                                    <div className="cell">
                                        <p><span className="yellowdot"></span> 4.	Micro-hydro Scheme</p>
                                    </div>
                                    <div className="cell">
                                ...
                                <div className="roww">
                                    <div className="cell">
                                        <p><span className="yellowdot"></span> 5.	Wind turbine Scheme</p>
                                    </div>
                                    <div className="cell">
                                ...
                                <div className="roww">
                                    <div className="cell">
                                        <p><span className="yellowdot"></span> 6.	Business hub Shceme</p>
                                    </div>
                                    <div className="cell">
                                ...
                                <div className="roww">
                                    <div className="cell">
                                        <p><span className="tealdot"></span> 7.	Forestry Scheme</p>
                                    </div>
                                    <div className="cell">
                                ...
                                <div className="roww">
                                    <div className="cell">
                                        <p><span className="purpledot"></span> 8.	Campsite and Cabins Scheme</p>
                                    </div>
                                    <div className="cell">
                                        <p>Potential for a community owned campsite and areas for caravans, campervans and Cabins. The shower toilet block could be made available to public use (for a fee) to allow campervan and other tourists to use the facilities.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div className="roww">
                                    <div className="cell">
                                        <p><span className="purpledot"></span> 9.	Market Garden Scheme</p>
                                    </div>
                                    <div className="cell">
                                ...
                                <div className="roww">
                                    ...
                                    <div className="cell">
                                        <p>Your Team can develop your own idea. You will need to carry out a SWOT analysis, determine your Capital Costs and Running Costs and also find out where the funding to both start and keep your scheme running would come from.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-4">
                            ...
                            <div className="side-grey">
                                ...
                                <p className="sm-type-amp"><Link to="/student/stage-2/about-glenclas-people">Hear from the people of Glenclas</Link></p>
