                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            ...
                            <p className="sm-type-lead mb-3">
                                ...
                                the (fictional) village of GLENCLAS. Below is a
                            ...
                            <Tabs>
                                <TabList>
                                    <Tab>
                                        <h6 className="sm-type-amp">Glenclas, Highland</h6>
                                    </Tab>
                                    <Tab>
                                        <h6 className="sm-type-amp">Geography</h6>
                                    </Tab>
                                    <Tab>
                                        <h6 className="sm-type-amp">Attractions</h6>
                                    </Tab>
                                    <Tab>
                                        <h6 className="sm-type-amp">Other facilities</h6>
                                    </Tab>
                                    <Tab>
                                        <h6 className="sm-type-amp">The Quest</h6>
                                    </Tab>
