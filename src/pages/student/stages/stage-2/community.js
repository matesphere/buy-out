...
const AccordionItem = ({ label, isCollapsed, handleClick, children }) => {
    return (
        <>
            <button className={`accordion-button sm-type-drum sm-type-drum--medium mt-4 mb-4 ${isCollapsed ? 'button-collapsed' : 'button-expanded'}`} onClick={handleClick}>
                {label}
            </button>
            <div
                    ...
                    <div className="row">
                        <div className="col-lg-8">
                            ...
                            <p className="sm-type-guitar sm-type-guitar--medium mb-2">
                                Click on the buttons below to see what the community and experts have to say.
                            </p>

                            <Accordion defaultIndex="1" onItemClick={console.log}>
                                <AccordionItem label="Affordable Housing Scheme" index="1">
                                    <div className="row">
                                        <div className="col-lg-8">
                                            ...
                                            <p className="sm-type-lead mb-2">
                                                If this community is to thrive and grow, we need to be able to provide more decent houses for
                                                people to live in. The houses that there are in the Glen are mostly large, old and expensive. A lot of
                                                them need work done on them and they are very expensive to heat.
                                            </p>
                                        </div>
                                    ...
                                    <div className="row mb-4">
                                        <div className="col-lg-12">
                                            <p className="sm-type-guitar mb-2">What problem does this idea solve for you?</p>

                                            <p className="sm-type-lead mb-2">As a young adult in this community, I can’t see myself ever being able to afford to buy a
                                            ...
                                            <p className="sm-type-guitar mb-2">Why do you think this is the right approach for yourself and the community?</p>

                                            <p className="sm-type-lead mb-2">I think that this is just what we need. The houses that could be built as part of this scheme would
                                ...
                                <AccordionItem label="Forestry Scheme" index="4">
                                    ...
                                    <div className="row mb-4">
                                        <div className="col-lg-12">
                                            ...
                                            <p className="sm-type-lead mb-2">Trees absorb large quantities of carbon dioxide as they grow and therefore become what is known as a ‘carbon sink’, storing the carbon and keeping it out of the atmosphere where it would otherwise contribute to global warming. Hence, planting a forest contributes to a global effort to reduce the concentration of carbon dioxide in the atmosphere.</p>

                                            <p className="sm-type-guitar mb-2">What do you believe this can bring in terms of improvements to the community here in Glenclas?</p>
                                            <p className="sm-type-lead mb-2">The presence of a broadleaved forest on the hill overlooking the village of Glenclas will undoubtedly enhance its scenic beauty. There is nothing that emphasises the changing seasons more than trees, as they colour up in spring, provide a mosaic of different shades of green through the summer and then turn to rich browns and yellow before the leaves finally fall, leaving the skeletal outlines of the trees to face the winter months.</p>

                                            <p className="sm-type-lead mb-2">A carefully planned path through the forest would provide a wonderful amenity for the local community as well as for visitors.</p>

                                            <p className="sm-type-lead mb-2">In the future, it would be possible to graze cattle within the forest at certain times of the year and so the land could also then be used for agricultural productivity.</p>

                                            <p className="sm-type-guitar mb-2">What is it about the development that you think will mean it will be viable and successful?</p>
                                            <p className="sm-type-lead mb-2">This is definitely a low-risk option for the Community as forestry schemes like this are being pushed very hard by the Government at the moment. The benefits of the scheme are very clear and there is funding available through Government schemes.</p>
                                        </div>
                                    </div>
                                </AccordionItem>

                                <AccordionItem label="Micro-hydro Scheme" index="5">
                                    <div className="row">
                                        <div className="col-lg-8">
                                            <p className="sm-type-guitar mb-2">Can you sum up your development idea for us in simple terms?</p>
                                            <p className="sm-type-lead mb-2">The West Coast of Scotland is famous for its rain, that falls surprisingly consistently throughout the year. This means that, although there can be dry or wet spells during each year, there is no dry or wet season. The topography of the land is inherently mountainous and these two factors combine to provide perfect opportunities to ‘harvest’ energy. Hydraulic power can be captured wherever a flow of water falls from a higher level to a lower level and two factors are required: a substantial Flow Rate of water (Q) and a significant vertical fall of the water, the Head (H). The high rainfall provides Q and the local topography provides H.</p>
                                ...
                                <AccordionItem label="Community Shop and Post Office" index="8">
                                    ...
                                    <div className="row mb-4">
                                        <div className="col-lg-12">
                                            ...
                                            <p className="sm-type-lead mb-2">If the Community purchased the shop it would look for a Manager who would occupy the flat above the shop, which consists of 2 bedrooms, a kitchen, living room, study and bathroom. The shop would be staffed with volunteers from the Community, overseen by the Manager. This would mean that the hours worked by the Manager would not be as all-consuming as the current shop keepers have to work now. This is probably the reason why nobody has been found to take on the lease under the current arrangements.</p>

                                            <p className="sm-type-guitar mb-2">What problem does this idea solve for you?</p>
                                            <p className="sm-type-lead mb-2">It is 26 miles to the nearest town and this is just too far for some of our more elderly residents, like myself. We really rely on the shop for our weekly essentials and it also performs an important role as a meeting place where people can have a chat. It is also a place where local information is displayed and everybody can therefore keep up with what’s going on up and down the Glen. It is not an exaggeration to say that I, and many of my friends and neighbours would be lost without our shop.</p>

                                            <p className="sm-type-guitar mb-2">Why do you think this is the right approach for yourself and the community?</p>
                                            <p className="sm-type-lead mb-2">We can get funding to make the purchase of the property, but the start-up costs to get the new business up and running would have to be met by the Community buying shares in the business. Unlike other share options, there would be no dividends paid out to the shareholders and therefore there would be no annual return for those people who buy share. However, the ‘pay-back’ is that people would secure the future of their shop.</p>

                                            <p className="sm-type-lead mb-2">The other bonus of having a share option is that the Community would have a stake in how well the shop did in the future. It would encourage people to spend more money in our shop than they might have done before (even if they travel out of the Glen everyday for work) and it would make it more likely that people would want to volunteer to do a stint working in the shop, if only for a few hours a week.</p>
                                        </div>
                                    </div>
                                </AccordionItem>

                                <AccordionItem label="Wind Turbine Scheme" index="9">
                                    <div className="row">
                                        <div className="col-lg-8">
                                            <p className="sm-type-guitar mb-2">Can you sum up your development idea for us in simple terms?</p>
                                            <p className="sm-type-lead mb-2">The west of Scotland has some of the best, most reliable wind resources in the world. The hill to the south of Glenclas would provide an ideal site for a turbine as it provides an elevation that would give increased wind speed. Obviously there are days when the wind will not have sufficient velocity to turn the turbine, but these days are relatively few on the west coast.</p>
