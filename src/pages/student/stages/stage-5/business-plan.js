  ...
  return (
    <>
      ...
      <main className="the-quest">
        ...
        <div className="save-icon"><SaveIcon /> Save progress</div>
          ...
          <div className="row">
            <div className="col-lg-8">
              ...
              <p className="sm-type-lead mb-2">
                Complete the following form to submit your business plan.
              </p>
            </div>
            <div className="col-lg-4">
              ...
              <div className="side-grey">
                <p className="sm-type-amp mb-4">
                  Complete a Business Plan that will show how much money is
                  required.
                </p>

                <p className="sm-type-amp">
                  Show estimates of the costs and income expected over the first
            ...
            <div className="col-lg-12">
              <div className="form-holder-border">
                ...
                <p className="sm-type-amp mb-2">
                  ...
                  costs (the set-up costs) of each development option, giving a
                  total at the end. You must then show what funders you are
                  going to use to meet the total for each option. The Amount of
                  Funding Total should equal the Capital Costs Total for each
                  option.
                </p>
                ...
                <div className="side-grey mb-2">
                  <div className="row">
                    <div className="col-lg-12">
                      <p className="sm-type-drum sm-type-drum--medium mb-2 redorange-highlight">
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-3">
                      ...
                      <p className="sm-type-lead mb-4">Funder 1</p>
                      <p className="sm-type-lead mb-4">Funder 2</p>
                      <p className="sm-type-lead mb-4">Funder 3</p>
                      <p className="sm-type-lead mb-4">Funder 4</p>
                    </div>
                ...
                <div className="side-grey mb-2">
                  <div className="row">
                    <div className="col-lg-12">
                      <p className="sm-type-drum sm-type-drum--medium mb-2 redorange-highlight">
                        Option 2 : Camping Glamping Site
                      </p>
                    </div>
                  </div>
                  <div className="row mb-4">
            ...
            <div className="col-lg-12">
              <div className="form-holder-border">
                ...
                <p className="sm-type-amp mb-2">
                  ...
                  In the Cash Flow section, you should add the expected income
                  for each year, subtract the costs you have just calculated, to
                  give a final balance for each of the four years. This should
                  then be totalled down the 3 options to give a Project Balance
